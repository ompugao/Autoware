...
StereoProc::StereoProc (ros::NodeHandle &nh):
	rosnode (nh),
	...
	lastGoodLocalizationTimestamp (-1)
{
	...
	//imageSub = imageBuf->subscribe ("image_topic", 1, &StereoProc::imageCallback, this, th);

    imageSyncSub.registerCallback(boost::bind(&StereoProc::GrabStereo, this, _1, _2));
...
void StereoProc::GrabStereo(const sensor_msgs::ImageConstPtr& msgLeft,const sensor_msgs::ImageConstPtr& msgRight) {
...
bool StereoProc::convertMsgToCV(const sensor_msgs::ImageConstPtr& msg, cv::Mat& cvimg) {
...
/*
void StereoProc::imageCallback(const sensor_msgs::ImageConstPtr &msg)
{
...
void
StereoProc::publishPose (const tf::Transform *pose)
{
...
tf::Transform
StereoProc::localizeByReference(const tf::Transform &tfOrb)
{
...
tf::Transform
StereoProc::localizeByReference (
...
tf::Transform
StereoProc::localizeByReference (const tf::Transform &tfOrb, ORB_SLAM2::KeyFrame *kf)
{
